...
print(result["destination"])    # path where file was routed
...
All three directories are created automatically in the **caller's working directory** — not inside the installed package. This gives the consuming application full control over where files land.
